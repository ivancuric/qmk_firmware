...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  KC_LSFT  , KC_NO    , KC_Z     , KC_X    , KC_C    , KC_V    , KC_B     , KC_N     , KC_M     , KC_COMM  , KC_DOT    , KC_SLSH  , KC_UP    , MO(3)    ,
  ...
  _______  , KC_MPRV  , KC_MPLY  , KC_MNXT  , _______  , _______  , _______  , _______  , _______  , _______  , _______   , _______  , KC_PSCREEN  , RESET    ,
  ...
  _______  , RGB_HUD  , RGB_SAD  , RGB_VAD  , _______  , _______  , _______  , _______  , _______  , _______  , RGB_RMOD  , RGB_TOG  , RGB_MOD  ,
