...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  KC_LCTL  , KC_LGUI  , KC_LALT  , KC_SPC  , KC_SPC  , KC_SPC  , KC_RALT  , KC_LEFT  , KC_LEFT  , KC_DOWN  , KC_RGHT)  ,
  ...
  _______  , KC_MPRV  , KC_MPLY  , KC_MNXT  , _______  , _______  , _______  , _______  , _______  , _______  , _______   , _______  , KC_PSCREEN  , _______  ,
